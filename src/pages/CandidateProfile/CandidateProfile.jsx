...
const CandidateProfile = () => {
  ...
  const [checkAtr, setCheckAtr] = useState(false);
  ...
  useEffect(() => {
    loadUserFiles();
    const handleCheckRating2 = async () => {
  ...
  const handleReviewSubmitted = async (reviewForm) => {
    console.log("running", reviewForm);
                    ...
                    <>
                      <div className="flex items-center gap-2">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            (data.info.fullName = e.target.value)
                          }
                        />
                      </div>
                      <div className="flex items-center gap-2">
        ...
        {!checkAtr && (
          <div className="absolute top-10 right-10">
            <button
              ...
              className="border bg-white cursor-pointer rounded-md text-black font-bold px-2 py-3 hover:bg-slate-300 translate-1.5"
            >
              Đánh giá chức năng
            </button>
          </div>
